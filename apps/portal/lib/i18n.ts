...
const AR: Dict = {
  ...
  'pt.costPoints': '{n} نقطة',
  'pt.costFree': '{n} نقطة · {what} مجانًا',
  'pt.costOff': '{n} نقطة · خصم {sar} ريال',
  'reg.leadBonus': '{n} نقطة فور تسجيلك، ثم {pct}% من كل فاتورة تعود إليك نقاطًا.',
  'reg.leadNoBonus': 'احصل على {pct}% من كل فاتورة نقاطًا، ثم اخصمها من فاتورة لاحقة.',
  'reg.badPhone': '"{n}" ليس رقم جوال سعودي. جرّب 0500338808.',
  'w.min8': '8 أحرف على الأقل',
  'fg.codeLasts': 'يبقى الرمز صالحًا {n} دقيقة. إذا لم يصلك بريد فهذا العنوان غير مسجل في أي حساب. جرّب عنوانًا آخر، أو انضم.',
  'fg.sendAnother': 'أرسل رمزًا آخر',
  'cl.joinNow': 'انضم الآن',
  'cl.stillValid': 'تبقى هذه الفاتورة صالحة، فيمكنك استلام نقاطها بعد انضمامك.',
  'pt.claim': 'استبدال',
...
const EN: Dict = {
  ...
  'pt.costPoints': '{n} points',
  'pt.costFree': '{n} points · {what} free',
  'pt.costOff': '{n} points · {sar} SAR off',
  'reg.leadBonus': '{n} points the moment you sign up, then {pct}% of every bill back as points.',
  'reg.leadNoBonus': 'Get {pct}% of every bill back as points, then spend them off a later one.',
  'reg.badPhone': '"{n}" is not a Saudi mobile number. Try 0500338808.',
  'w.min8': 'at least 8 characters',
  'fg.codeLasts': 'The code lasts {n} minutes. If no mail arrives, that address is not on an account. Try another, or join.',
  'fg.sendAnother': 'send another code',
  'cl.joinNow': 'join now',
  'cl.stillValid': 'This receipt stays valid, so you can collect these points after you join.',
  'pt.claim': 'Claim',
